...
public class PlayerControl : MonoBehaviour 
{
	...
	//private float maxRollAngle = 15;
	//private float rollStepper = 0f;
	//private float tmp = 0;
	...
	{			
		if(timer < 0)
		{
			...
			//ascVelValue += Mathf.Abs(Physics.gravity.y) * Time.fixedDeltaTime;
			
			//this.transform.Translate(new Vector3(0,1,0) * ascVelValue, Space.World);
			//this.rigidbody.velocity = new Vector3(0,1,0) * ascVelValue * 30;
			// ===========================================================================
			
			// === Applying Movement & Ascending/Descing Velocity here ===================
			this.rigidbody.velocity = moveVelDir * moveVelValue + new Vector3(0,1,0) * ascVelValue;
			// ===========================================================================
